            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="number" class="form-control blue-border input-icon input-icon-right" data-testid="amount" placeholder="348" required/>
                  </div>
                  <div class="col-half-row">
                    <div class="flex-col"> 
                      <label for="vat" class="bold-label">TVA</label>
                      <input type="number" class="form-control blue-border" data-testid="vat" placeholder="70" required/>
                    </div>
                    <div class="flex-col">
                      <label for="pct" class="white-text">%</label>
                      <input required type="number" class="form-control blue-border" data-testid="pct" placeholder="20" required/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" accept="image/png, image/jpeg, image/jpg" class="form-control blue-border" data-testid="file" required/>
                  </div>
                </div>
            </div>
            <div class="row">
